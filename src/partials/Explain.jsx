...
function Explain() {
  return (
    <section className="relative">
      ...
      <div className="text-neutral-main  mx-auto my-6 flex justify-center py-3 sm:px-2">
        <h1 className="h3">Dyno erklärt die Tarife</h1>
      </div>
      <div className=" border-base-main container my-6 mx-auto flex items-center rounded-xl border-2 border-dotted p-3">
      ...
      <div className=" border-base-main container my-6 mx-auto mt-8 flex items-center rounded-xl border-2 border-dotted p-3">
        <div className="w-1/2 px-8">
